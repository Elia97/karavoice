    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">EventiApp</h3>
            <p className="mb-4 text-sm">La tua piattaforma per scoprire e partecipare agli eventi più interessanti.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {categorie.slice(0, 5).map((categoria) => (
                <li key={categoria.nome}>
                  <Link href={`/eventi?categoria=${categoria.nome.toLowerCase()}`} className="hover:text-white">
                    {categoria.nome}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>Email: info@eventiapp.it</li>
              <li>Telefono: +39 123 456 7890</li>
              <li>Indirizzo: Via degli Eventi 123, 00100 Roma</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} EventiApp. Tutti i diritti riservati.</p>
        </div>
      </div>
    </footer>
  )
